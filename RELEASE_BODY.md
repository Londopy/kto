...
**Installer (recommended):** download `kto-3.0.0-setup-<arch>.exe` and run it. It adds
...
**Portable zip:** download `kto-3.0.0-windows-<arch>.zip`, verify it (below), then run
...
In PowerShell, hash the file and compare it to the matching line in the checksums:
    ...
    Get-FileHash .\kto-3.0.0-windows-x64.zip -Algorithm SHA256
